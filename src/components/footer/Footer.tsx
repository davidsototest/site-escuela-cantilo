...
const Footer = () => {
    ...
    return (
        <Grid2 container columnSpacing={3} justifyContent='center'>
            ...
            <Grid2 xs={11} sm={5} md={3}>
                ...
                <div style={{marginTop: "20px"}}>
                    <span className="paragraph">
                        Lorem ipsum dolor sit amet elit , consectetur adipiscing , sed eiusmod tempor sit.
                    </span>
                </div>
                ...
                <div style={{width: '100%', marginTop: '25px', marginBottom: '45px'}}>
                    <Grid2 container justifyContent='center'>
                        <Grid2 xs={3} md={4} display='flex' justifyContent="center">
                            <a href="https://www.facebook.com/p/Escuela-Padre-Rafael-Cantilo-100024207500740/?locale=es_LA" target="_blank" rel="noopener noreferrer">
                                <FacebookIcon className="icon-red-social"/>
                            </a>
                        </Grid2>
                        <Grid2 xs={3} md={4} display='flex' justifyContent="center">
                            <a href="https://www.instagram.com/escuelapadrerafael/" target="_blank" rel="noopener noreferrer">
                                <InstagramIcon className="icon-red-social"/>
                            </a>
                        </Grid2>
                        <Grid2 xs={3} md={4} display='flex' justifyContent="center">
                            <a href="mailto:cobranzas@escuelapadrecantilo.edu.ar"  rel="noopener noreferrer">
            ...
            <Grid2 xs={12} sm={12} md={6} alignContent='center' justifyContent='center'>
                <span className="tittle-card"><RoomIcon/> Blvd. Oroño 3463, Rosario, Santa Fe </span>
                <iframe 
